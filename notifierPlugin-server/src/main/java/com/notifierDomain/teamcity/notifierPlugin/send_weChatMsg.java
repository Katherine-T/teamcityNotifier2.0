...
public class send_weChatMsg {
     ...
     * 本方法适用于 text 型微信消息，contentKey和contentValue只能组一对
     * @return String
     */
    ...
    protected String creategrouppostbotdata( String msgtype,String message
                                                 ) {
        WeChatData wcd = new WeChatData();
//        wcd.setTochat(chatid);
        wcd.setMsgtype(msgtype);
    ...
    protected String creategrouppostbotdata2( String msgtype,String message
            ,String mentionName) {
        WeChatData wcd = new WeChatData();
//        wcd.setTochat(chatid);
        wcd.setMsgtype(msgtype);
        ...
        Map<Object, Object> content = new HashMap<Object, Object>();
        content.put("content",message);
        content.put("mentioned_list", mentionlist);
        wcd.setText(content);
        return gson.toJson(wcd);
    }
    /**
    ...
    /**
     * @Title 创建微信机器人发送请求post实体
     * @param charset 消息编码
     *            ，contentType消息体内容类型，
     * @param url 微信消息发送请求地址，data为post数据，token鉴权token
     * @return String
     */
    public String postBot(String charset, String contentType, String url, String data) throws IOException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
